...
export class PublicFormComponent implements OnInit {
  ...
  leftColumnFields: FormField[] = [
    ...
    { label: 'District', name: 'District', type: 'dropdown', options: ['Guntur', 'Palnadu', 'Prakasham', 'Krishna'], readonly: false, disabled: false },
    { label: 'Mandal', name: 'Mandal', type: 'dropdown', options: ['Vinukonda', 'Narsaraopet', 'Guntur', 'Tenali', 'Sattenapalli'], readonly: false, disabled: false },
    { label: 'Village', name: 'Village', type: 'dropdown', options: ['Vinukonda', 'Savalyapuram', 'Nuzendla', 'Bollapalli'], readonly: false, disabled: false },
  ...
  fetchFormData() {
    this.http.get('https://8c1760ab-de98-40f9-b0c8-b649bfa189e1.mock.pstmn.io/user').subscribe((data: any) => {
  ...
  onSubmit() {
    ...
    if (Object.keys(this.errors).length === 0) {
      ...
      // Navigate to control room form with complaint ID as parameter
      // this.router.navigate(['/control-room-form', this.complaintId]);
